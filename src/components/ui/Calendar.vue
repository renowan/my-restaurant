<template>
  <div class="datepicker" :class="{'datepicker-justified': justified}">
    ...
    <div class="datepicker-wrapper" ref="popup" v-transfer="transfer" v-show="isWrapperShow" :style="paneStyle" >
      <div class=".datepicker-popup2"  @mouseover="handleMouseOver" @mouseout="handleMouseOver" v-show="displayDayView">
        ...
        <template v-for="(p, pan) in pane">
          <div class="datepicker-inner" v-bind:key="'inner2' + pan">
            <div class="datepicker-body">
              <p>{{stringifyDayHeader(currDate, pan)}}</p>
              <div class="datepicker-weekRange">
                <span v-for="(w, wIndex) in text.daysOfWeek" v-bind:key="'days-ofWeek-' + wIndex">{{w}}</span>
              </div>
              <div class="datepicker-dateRange">
                <span v-for="(d, index) in dateRange[pan]" class="day-cell" :class="getItemClasses(d)" :data-date="stringify(d.date)" @click="daySelect(d, $event)" v-bind:key="'day-cell-'+index"><div>
      ...
      <div class=".datepicker-popup2" v-if="!showDateOnly"  v-show="displayMonthView">
        <div class="datepicker-ctrl">
        ...
        <template v-for="(p, pan) in pane">
          <div class="datepicker-inner" v-bind:key="'inner' + pan">
            <div class="datepicker-body">
              <p>{{stringifyYearHeader(currDate, pan)}}</p>
              <div class="datepicker-monthRange">
                <template v-for="(m, $index) in text.months">
                  <span :class="{'datepicker-dateRange-item-active':
                      (text.months[parse(value).getMonth()]  === m) &&
                      currDate.getFullYear() + pan === parse(value).getFullYear()}"
                      v-bind:key="'dateRange-item' + $index"
      ...
      <div class=".datepicker-popup2" v-if="!showDateOnly" v-show="displayYearView">
        <div class="datepicker-ctrl">
          ...
          <div class="datepicker-inner" v-bind:key="'inner' + pan">
            <div class="datepicker-body">
              ...
              <div class="datepicker-monthRange decadeRange">
                <template v-for="(decade, dIndex) in decadeRange[pan]">
                  <span :class="{'datepicker-dateRange-item-active':
                      parse(inputValue).getFullYear() === decade.text}"
                      v-bind:key="'dateRange-item' + dIndex"
    ...
    getDateRange () {
      ...
      for (let p = 0; p < this.pane; p++) {
        ...
        for (let i = 1; i <= dayCount; i++) {
          ...
          if (week === 6) {
            sclass = sclass.length < 1 ? 'day-6' : sclass += ' day-0'
          }
          this.dateRange[p].push({
            text: i,
            date: date,
